                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-10 mt-1  mb-1" data-aos-delay="200">
                                    <div class="in-sec demo">
                                        ...
                                        <div id="sectorInfo"></div>
                                        <button class="tablink" onclick="openCity('Electricity', this, '#A8E6CE')">Electricity</button>
                                        <button class="tablink" onclick="openCity('Transport', this, '#DCEDC2')">Transport</button>
                                        <button class="tablink" onclick="openCity('AFOLU', this, '#FFD3B5')">AFOLU</button>
                                        <button class="tablink" onclick="openCity('Solidwaste', this, '#FFAAA6')">Solidwaste</button>
                                        <button class="tablink" onclick="openCity('WasteWater', this, '#FF8C94')">WasteWater</button>
                                        <button class="tablink" onclick="openCity('Industry', this, '#9DE0AD')">Industry</button>
                                        <button class="tablink" onclick="openCity('CookingFuel', this, '#83AF9B')">CookingFuel</button>
