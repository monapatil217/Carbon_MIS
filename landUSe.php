                            ...
                            <div class="row ">
                                <div class="col-md-12 mb-3 text-center">
                                    <button class="btn btn-primary " type="button"
                                        onclick="saveLandData();">SAVE</button>
                                </div>
                            </div>
                        </form>
                        <!-- Start PopUp div -->
                    ...
                    <div class="in-sec infoFont">
                        ...
                        <ul style="margin-left: 10px;">
                            <li class="popupli"> Land plays an important role in global cycles of greenhouse gases
                                ...
                                Land use activities can result in emissions of such greenhouse gases to the atmosphere
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-2"
                                ...
                                <i class="fa fa-download" style="font-size:24px;color:#67b7dc" class="btn btn-primary "
                                    value="download" onclick="CreatePDFfromHTML('landUse')"></i>
                            </div>
                        </div>
