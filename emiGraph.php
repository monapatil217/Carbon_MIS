            ...
            <div class="row">
                <div class="col-md-12 col-lg-12  mb-3 s " data-aos-delay="200">
                    <div class="in-sec">
                        ...
                        <button class="tablink" onclick="openPage('News', this, '#888')"
                            id="defaultOpen">Sectoral Stack</button>
                        <button class="tablink" onclick="openPage('Contact', this, '#88')">Sectoral Emission </button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <button id="cmd" class="btn btn-primary "
                                        onclick="CreatePDFfromHTML('electricity')">Print</button>
                                </div>
                            </div>
