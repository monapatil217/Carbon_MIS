  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="row mt-5">
        ...
        <div class="col-md-12 col-lg-8  mb-3 mt-3 s" data-aos-delay="200">
          <div class="in-sec">
        ...
        <div class="col-md-12 col-lg-4  mb-3 mt-3 s" data-aos-delay="200">
          <div class="in-sec">
            <div class="icon"><i class="ri-stack-line"></i></div>
          </div>
        </div>
        ...
        <div class="col-md-12 col-lg-8  mb-3 mt-3 s" data-aos-delay="200">
          <div class="in-sec">
            <div class="icon"><i class="ri-stack-line"></i></div>
            <h4 class="title">Trasport</h4>
            <p class="description">Voluptatum excepturi</p>
          </div>
        </div>

        <div class="col-md-12 col-lg-12  mb-3 mt-3 s" data-aos-delay="200">
          <div class="in-sec">
            <div class="icon"><i class="ri-stack-line"></i></div>
            <h4 class="title">Electricity</h4>
            <p class="description">Voluptatum deleniti atque corrupti quos dolor
              Voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi</p>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mt-5  mb-lg-0" data-aos="zoom-in"
          ...
          <div class="icon-box">
            ...
            <h4 class="title"><a href="">AFOLU</a></h4>
        ...
        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5  mt-5 mb-lg-0" data-aos="zoom-in"
          ...
          <div class="icon-box">
            <div class="icon"><i class="ri-fingerprint-line"></i></div>
            <h4 class="title"><a href="">Industry</a></h4>
            <p class="description">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis</p>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mt-5  mb-lg-0" data-aos="zoom-in"
          ...
          <div class="icon-box">
            ...
            <h4 class="title"><a href="">SolidWaste</a></h4>
        ...
        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5  mt-5 mb-lg-0" data-aos="zoom-in"
          ...
          <div class="icon-box">
            <div class="icon"><i class="ri-command-line"></i></div>
            <h4 class="title"><a href="">Waste Water</a></h4>
            <p class="description">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia</p>
          </div>
        </div>
