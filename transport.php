                        ...
                        <form class="needs-validation" novalidate>
                            ...
                            <div class="row ">
                                <div class="col-md-12 mb-3 text-center">
                                    <button class="btn btn-primary " type="button" onclick="saveTransData();">SAVE</button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="in-sec infoFont">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-2" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                                <i class="fa fa-download" style="font-size:24px;color:#67b7dc" class="btn btn-primary " value="download" onclick="CreatePDFfromHTML('transport')"></i>
