            ...
            <div class="row  justify-content-center">
                <div class="col-md-12 col-lg-4  mb-3  s" data-aos-delay="200">
                    <div class="in-sec">
                        ...
                        <marquee width="100%" direction="left" height="30px" scrollamount="2"> sq.km - square kilometer
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-2" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                                <!-- <button id="cmd" class="btn btn-primary "
                                    onclick="CreatePDFfromHTML('forest')">Print</button> -->
                                <i class="fa fa-download" style="font-size:24px;color:#67b7dc" class="btn btn-primary " value="download" onclick="CreatePDFfromHTML('forest')"></i>
                            </div>
                        </div>
