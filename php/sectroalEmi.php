...
$type = $data->type;$finalDataArray=[];
$tableEmiarray = ["ele_emi","fc_land_emi","fule_emi","indu_eng_emi","land_emi","live_emi","solid_emi","trans_emi","waste_emi"];

if($type == 'Electricity'){  $tableName  = 'ele_emi';
}else if ($type == 'Transport'){ $tableName = 'trans_emi';
}else if ($type == 'LiveStoks') { $tableName = 'live_emi';
}  else if ($type == 'CropLand'){ $tableName = 'fc_land_emi';
}  else if ($type == 'Forest'){ $tableName = 'fc_land_emi';
}  else if ($type == 'LandUse'){ $tableName = 'land_emi';
}  else if ($type == 'Energy'){ $tableName = 'indu_eng_emi';
}  else if ($type == 'Product'){ $tableName = 'trans_emi';}
