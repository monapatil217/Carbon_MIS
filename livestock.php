                    ...
                    <div class="in-sec infoFont">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-2" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                                <i class="fa fa-download" style="font-size:24px;color:#67b7dc" class="btn btn-primary " value="download" onclick="CreatePDFfromHTML('liveStock')"></i>
                                <!-- <button id="cmd" class="btn btn-primary "
                                    onclick="CreatePDFfromHTML('liveStock')">Print</button> -->
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-2" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
