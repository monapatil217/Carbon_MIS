                        ...
                        <div class="row align-items-center justify-content-center" id="moreInfo">
                            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 containern"
                                ...
                                <div class="fade-to-img" onclick="showLiveStockInfo();">
                                    <!-- <img class="reggot" id="popup-btn" src="img/horse.png" width="80" height="80"><br><br> -->
                                     <!-- <img id="popup-btn" src="img/gifhorse.gif" style="width:60px;height:60px;"><br><br> -->
                                      <img id="popup-btn" src="img/horse.gif" style="width:70px;height:50px;"><br><br>
                                       <div class="overlay">
