...
<body>
    ...
    <div class="fade-to-b">
        <a href="#services"><img class="emissionBtn" src="img/logo3.png"></a>
  ...
  <a class="carousel-control-next" href="#demo" data-slide="next">
    ...
    <!-- /////////// -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 col-md-12 col-sm-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                        <img src="assets/img/carbongraphic1.jpg" class="rounded img-fluid d-block mx-auto" alt="App">
                    </div>
                    <div class="right-text col-lg-5 col-md-12 col-sm-12 mobile-top-fix">
                        ...
                        <div class="left-text">
                            <p> Today carbon dioxide levels are the highest they’ve ever been in human history, and
                                ...
                                per million (ppm). This represents a 47 percent increase since the beginning of the
                                Industrial Age, when the concentration was near 280 ppm. To prevent the
                                catastrophic effect of rising carbon emissions, countries are taking mitigation actions such
                                reducing deforestation,
                                using clean energy, investing in efficient carbon capture technology,
                                etc. India too, is moving forward with the goal of reducing its carbon footprint by 30 to 35
                                percent.
                            </p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hr">
                            <p>Carbon Footprint refers to the amount of CO2 emissions associated with all the activities of
                                a person or other entity.CO2 emissions come from the burning of fossil fuels like coal,
                                natural gas and oil,
                                clearing of forests and other land use changes (9%), as well as industrial processes such as
                                cement manufacturing (4%).Natural sources of carbon emissions include decomposition, ocean
                                release and respiration. This rise in CO2 has severe impact on the environment. It leads to
                                rise in air pollution, Climate change, Acid rain and Breathing problems in living beings.
                                To reduce our carbon emissions, it is important to know how much CO2
                                we emit and this is what the site aims to do, i.e. to help you calculate your carbon
                                footprint and suggest measures to reduce it.
                            </p>
      ...
      <div class="container">
          <div class="row">
              <div class="col-lg-7 col-md-12 col-sm-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                  <img src="assets/img/waterimg.png" class="rounded img-fluid d-block mx-auto" alt="App">
              </div>
              <div class="right-text col-lg-5 col-md-12 col-sm-12 mobile-top-fix">
                  <div class="left-heading">
                      <h5>Start measuring your Water Footprint</h5>
                  </div>
                  <div class="left-text">
                      <p><b><i>Water Footprint </i></b> represents the amount of water
                          which is directly and indirectly used to support human consumption and activities. It helps
                          us to understand for what purposes our limited freshwater resources are being consumed and
                          polluted. The impact it has depends on where the water is taken from and when. For instance,
                          if it comes from a place where water is already scarce, the consequences can be significant
                          and may require action.
                          The water footprint has three components: green, blue and grey:</p>
                      <p><b>Green water</b> footprint is water from precipitation that is stored in the root zone of
          ...
          <div class="row">
              <div class="col-lg-12">
                  <div class="hr">
                      <p><b>Blue water</b> footprint is water that has been sourced from surface or groundwater
                          resources and is either evaporated, incorporated into a product or taken from one body of
                          water and returned to another, or returned at a different time. </p>
                      <p><b>Grey water</b> footprint is the amount of fresh water required to assimilate pollutants to
                          meet specific water quality standards. </p>
                      <p> Freshwater is a scarce resource; its annual availability is limited and demand is growing.
                          The water footprint of humanity has exceeded sustainable levels and is unequally
                          distributted.
                          information about water footprints of communities and businesses will help to understand how
                          we can achieve a more sustainable
                          use of fresh water. There are many spots in the world where serious water depletion or
                          pollution takes place:
                          rivers running dry, dropping lake and groundwater levels and endangered species because of
                          contaminated water.
                          The water footprint helps to show the link that exists between our daily consumption of
                          goods and the problems of water depletion and pollution that exist elsewhere .</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-md-12 col-sm-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                <img src="assets/img/ecoimg.png" class="rounded img-fluid d-block mx-auto" alt="App">
            </div>
            <div class="right-text col-lg-5 col-md-12 col-sm-12 mobile-top-fix">
                <div class="left-heading">
                    <h5>Start measuring your Ecological Footprint</h5>
                </div>
                <div class="left-text">
                    <p>The<b><i> Ecological Footprint</i></b> is the only metric that measures how much nature we have and how much nature we use.The footprint helps countries improve sustainability and well-being , it helps local leaders optimize public projects investment and also helps individuals understand their impact on the planet.The Ecological Footprint tracks the use of productive surface areas.
                        Typically these areas are: cropland, grazing land, fishing grounds, built-up land, forest area, and carbon demand on land.</p>
            ...
            in iste officiis commodi quidem hic quas.</p> -->
                ...
                <div class="faq-list extraC">
                    <ul>
                        ...
                        <li data-aos="fade-up">
                            <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">Why focus first on carbon dioxide? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                        ...
                        <li data-aos="fade-up" data-aos-delay="100">
                            <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">Why do I need to know my carbon footprint and what does it mean <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
