                        ...
                        <div class="row align-items-center justify-content-center" id="moreInfo">
                            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 containern"
                                ...
                                <div class=" fade-to-img" onclick="showWaterInfo();">
                                    <!-- <img class="reggot" id="popup-btn" src="img/water-drop.png" width="80" height="80"><br><br> -->
                                     <img id="popup-btn" src="img/gifwastewater.gif" style="width:150px;height:50px;"><br><br>
                                      <!-- <img id="popup-btn" class="blink" src="img/gifw-unscreen.gif" style="width:50px;height:50px;"><br><br> -->
                                       <div class="overlay">
