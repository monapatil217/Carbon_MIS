                ...
                if (check == "true") {
                    ...
                    $.each(eledata, function (index, element1) {
                        ...
                        html = '<div class="row justify-content-center">' +
                            ...
                            '<div class="input-group mb-3">' +
                            '<input type="number" id="harwested" name="harwested" value="' + element1.harwested + '"  class="form-control" placeholder=" Harwested Land " aria-label=" Harwested Land " aria-describedby="basic-addon2">' +
                            '<span class="input-group-text" id="basic-addon2">sq.km</span>' +
                            '</div>' +
                            '</div>' +
                            '</div>';
                    ...
                    html = '<div class="row justify-content-center">' +
                        ...
                        '<i class="bi-info-circle-fill" data-toggle="tooltip" data-placement="top" title="This is the area occupied by woody\n perennial crops like mango, citrus crops,\n cashew , coconut, bael, jackfruit, banana."></i>' +
                        '<div class="input-group mb-3">' +
                        '<input type="number" id="perennial" name="perennial" class="form-control" placeholder="Woody Perennial Cover" aria-label="Woody Perennial Cover" aria-describedby="basic-addon2">' +
                        '<span class="input-group-text" id="basic-addon2">sq.km</span>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        ...
                        '<i class="bi-info-circle-fill" data-toggle="tooltip" data-placement="top" title=" It is the land used to produce agricultural \ncrops like rice, bajra,wheat,pulses,\nsugarcane,cotton,vegetables,etc."></i>' +
                        '<div class="input-group mb-3">' +
                        '<input type="number" id="harwested" name="harwested" class="form-control" placeholder=" Harvested Land " aria-label=" Harwested Land " aria-describedby="basic-addon2">' +
                        '<span class="input-group-text" id="basic-addon2">sq.km</span>' +
                        '</div>' +
                        '</div>' +
                        '</div>';
...
function saveCropData() {
    ...
    flag += customInputValidator(perennial, "perennial");

    var harwested = document.getElementById("harwested").value;
    flag += customInputValidator(harwested, "harwested");
