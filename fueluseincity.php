                     ...
                     <div class="in-sec">
                         ...
                         <div class="row justify-content-center">
                             ...
                             <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-2" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                                 ...
                                 <i class="fa fa-download" style="font-size:24px;color:#67b7dc" class="btn btn-primary " value="download" onclick="CreatePDFfromHTML('cookingFuel')"></i>
                             </div>
                         </div>
                         <div class="row align-items-center justify-content-center">
                             <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-2" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                                 <button type="button" class="btn btn-primary" onclick="redirect();">NEXT <i class="fa fa-angle-double-right" style='font-size:18px;color:gray'></i></button> </div>
                         </div>
                     </div>
                 </div>
             </div>
